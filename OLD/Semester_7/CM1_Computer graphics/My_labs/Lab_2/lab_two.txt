...
secBlob.position.set(    0, 
					  ...
					  ( -0.3 )*handLength ); //this way "seconds" blob would be less obstructed by hours and minute "hands"
...
{	
	...
	{
		seconds = newSeconds; //and we assign new seconds into the older seconds' variable
