...
N = 42; % compensate for estimation error
...
FIG3 = figure('Name','Equiripple Linear-Phase FIR Filter','NumberTitle','off','Units','normal','Position',[.44 .30 .45 .55]);
subplot(2,1,1), stem(0:N,b_FIR_LP), grid
xlabel('n \rightarrow'), ylabel('h[n] LP \rightarrow')
axis([0 N -.2 .8]);
subplot(2,1,2), stem(0:N,b_FIR_HP), grid
xlabel('n \rightarrow'), ylabel('h[n] HP\rightarrow')
axis([0 N -.2 .8]);
