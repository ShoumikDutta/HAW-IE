...
FFT8_Radix2.obj: ../FFT8_Radix2.c $(GEN_OPTS) $(GEN_HDRS)
	@echo 'Building file: $<'
	@echo 'Invoking: C6000 Compiler'
	"C:/ti/ccsv5/tools/compiler/c6000_7.4.20/bin/cl6x" --abi=coffabi -g --include_path="C:/ti/ccsv5/tools/compiler/c6000_7.4.20/include" --define=CHIP_6713 --display_error_number --diag_warning=225 --diag_wrap=off --preproc_with_compile --preproc_dependency="FFT8_Radix2.pp" $(GEN_OPTS__FLAG) "$<"
