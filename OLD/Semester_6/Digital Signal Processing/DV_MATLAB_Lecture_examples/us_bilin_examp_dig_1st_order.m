...
% 24-May-06
%---------------------------------------------------------------------------
% % us_bilin_examp_dig_1st_order.m
% 
% US 18-May-06
%
...
% s=j*2*pi*freq;
% H_von_s = omega_g_ana./(omega_g_ana+s); 

% in general
[nums,dens]=butter(1, omega_g_ana, 's');
...
numz=T/(T+2/omega_g_ana)*[1,1]
denz=[1, (T-2/omega_g_ana)/(T+2/omega_g_ana)]
...
[numz_chk,denz_chk]=bilinear(nums,dens, Fs)
