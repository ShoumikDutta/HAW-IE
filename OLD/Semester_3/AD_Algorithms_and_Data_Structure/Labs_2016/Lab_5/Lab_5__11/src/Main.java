...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        tree.put("e", 1);
        tree.put("f", 1);
        System.out.printf("worst tree depth for 6 elements is %d\n", tree.depth());
        ...
        tree2.put("of", 1);
        tree2.put("times", 1);
        System.out.printf("pseudo random tree depth for 6 elements is %d\n\n", tree2.depth());
        ...
        for(int k = 2; k <= 10; k += 2)
        {
            ...
            while(token.hasMoreTokens())
            {
                ...
                tree3.put(currentWord, 1);
                System.out.printf("When add new item to tree, then depth for %d elements is %d\n", tree3.getCount(), tree3.depth());
                if (tree3.getCount() == N)
                    //when in the tree it gains the maximum of what we need in this iteration - we break it
                    break;
            }
            System.out.println();
        }
