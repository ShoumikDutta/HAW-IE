...
//	static final String driverName = "jdbc:oracle:thin:@ora14.informatik.haw-hamburg.de:1521:inf14";
...
public class Main {
	...
	// TODO: provide the correct class name of the driver!
	//jdbc:oracle:thin:@ora14:1521
	// TODO: provide the correct JDBC-URL for the HAW database!
	static final String url = "ora14.informatik.haw-hamburg.de";

	static final String user     = MyDBUserPassword.user;
	static final String password = MyDBUserPassword.password;
	
	static final String port ="1521";
	static final String SID = "inf14";
	static final String driverName = "jdbc:oracle:thin:@ora14.informatik.haw-hamburg.de:1521:inf14";
