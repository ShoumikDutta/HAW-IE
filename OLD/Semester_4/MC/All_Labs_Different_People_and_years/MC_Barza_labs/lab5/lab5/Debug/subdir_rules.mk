...
IntPortDHandler.obj: ../IntPortDHandler.c $(GEN_OPTS) $(GEN_HDRS)
	@echo 'Building file: $<'
	@echo 'Invoking: ARM Compiler'
	"C:/ti/ccsv5/tools/compiler/arm_5.1.1/bin/armcl" -mv7M3 --code_state=16 --abi=eabi -me --include_path="C:/ti/ccsv5/tools/compiler/arm_5.1.1/include" --include_path="E:/StellarisWare" --include_path="D:/" -g --diag_warning=225 --display_error_number --preproc_with_compile --preproc_dependency="IntPortDHandler.pp" $(GEN_OPTS__FLAG) "$<"
