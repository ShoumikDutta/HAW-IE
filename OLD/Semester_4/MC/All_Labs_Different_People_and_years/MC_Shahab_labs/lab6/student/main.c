...
volatile unsigned  char buffer[BUFFERLENGTH]; // Rx data buffer
...
void main(void){
	...
	char shift[50]={0.};
	char matrix[37][6]={{'A',0xFE,0x11,0x11,0xFE,0x00},
			{'B',0xFF,0x89,0x89,0x76,0x00},
			{'C',0x7E,0x81,0x81,0x42,0x00},
			{'D',0xFF,0x81,0x81,0x7E,0x00},
			{'E',0xFF,0x89,0x89,0x81,0x00},
			{'F',0xFF,0x05,0x05,0x01,0x00},
			{'G',0xFF,0x81,0x91,0xF1,0x00},
			{'H',0xFF,0x10,0x10,0xFF,0x00},
			{'I',0x00,0x81,0xFF,0x81,0x00},
			{'J',0x40,0x81,0xFF,0x01,0x00},
			{'K',0xFF,0x24,0x42,0x81,0x00},
			{'L',0xFF,0x80,0x80,0x80,0x00},
			{'M',0xFF,0x02,0x04,0x02,0xFF},
			{'N',0xFF,0x0C,0x30,0xC0,0xFF},
			{'O',0x7E,0x81,0x81,0x7E,0x00},
			{'P',0xFF,0x09,0x09,0x06,0x00},
			{'Q',0x7E,0x81,0xA1,0x7E,0x80},
			{'R',0xFF,0x19,0x29,0x46,0x80},
			{'S',0x86,0x89,0x89,0x71,0x00},
			{'T',0x01,0x01,0xFF,0x01,0x00},
			{'U',0x7F,0x80,0x80,0xFF,0x00},
			{'V',0x07,0x38,0xC0,0x38,0x07},
			{'W',0xFF,0x40,0x20,0x40,0xFF},
			{'X',0xE7,0x18,0x18,0xE7,0x00},
			{'Y',0x01,0x02,0xFC,0x02,0x01},
			{'Z',0xE9,0x99,0x89,0x8F,0x00},
			{' ',0x00,0x00,0x00,0x00,0x00},
			{'0',0xFE,0x82,0x82,0xFE,0x00},
			{'1',0x00,0x00,0xFE,0x00,0x00},
			{'2',0xF2,0x92,0x92,0x9E,0x00},
			{'3',0x92,0x92,0x92,0xFE,0x00},
			{'4',0x1E,0x10,0x10,0xFE,0x00},
			{'5',0x9E,0x92,0x92,0xF2,0x00},
			{'6',0xFE,0x92,0x92,0xF2,0x00},
			{'7',0x02,0x02,0x02,0xFE,0x00},
			{'8',0xFE,0x92,0x92,0xFE,0x00},
			{'9',0x1E,0x12,0x12,0xFE,0x00},
	};
	int i ;
	int k ;
	char temp=0;
	int delay[50]={3000,3000,2500,2500,2000,1300,1300,1200,1500,1200 /*10*/,800,800,800,800,800,800,800,800,800,800 /*20*/,700,700,700,700,700,800,800,800,800,900 /*30*/,800,800,800,800,800,800,800,1000,1000,1000 /*40*/,1000,1000,1000,1000,1000,1500,2300,2000,3000,2500 /*50*/};
	portconfig();
	timerconfig();
	uartconfig();
	configPortE();
